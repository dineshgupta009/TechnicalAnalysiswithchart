...
public class FeignBuilder1 {
    ...
    public static Map<String, String> builder() {
        ...
        headerMap1.put("accept-language", "en-US,en;q=0.9");
        headerMap1.put("referer", "https://www.nseindia.com/option-chain");
        headerMap1.put("accept-encoding", "identity");
        headerMap1.put("user-agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.93 Safari/537.36");
